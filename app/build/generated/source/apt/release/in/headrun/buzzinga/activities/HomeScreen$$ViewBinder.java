...
public class HomeScreen$$ViewBinder<T extends in.headrun.buzzinga.activities.HomeScreen> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131755135, "field 'Listfooter'");
    ...
    view = finder.findRequiredView(source, 2131755134, "field 'browser_progress'");
    target.browser_progress = finder.castView(view, 2131755134, "field 'browser_progress'");
  }
