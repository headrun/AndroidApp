...
public class ArticleWebDisplay$$ViewBinder<T extends in.headrun.buzzinga.activities.ArticleWebDisplay> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131624085, "field 'articlebrowser_close'");
    target.articlebrowser_close = finder.castView(view, 2131624085, "field 'articlebrowser_close'");
