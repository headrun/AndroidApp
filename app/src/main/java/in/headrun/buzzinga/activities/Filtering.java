...
public class Filtering extends AppCompatActivity implements View.OnClickListener {
    ...
    public boolean loc_check(String loc) {
        Log.i("Log_tag", "BLOCATION size is" + Constants.BLOCATION.size() + "loc is" + loc);
