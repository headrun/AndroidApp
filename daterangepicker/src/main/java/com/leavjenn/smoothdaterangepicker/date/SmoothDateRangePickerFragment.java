...
public class SmoothDateRangePickerFragment extends DialogFragment implements OnClickListener,
    ...
    public static SmoothDateRangePickerFragment newInstance(OnDateRangeSetListener callBack, int year,
                                                            ...
                                                            int dayOfMonthEnd) {
        SmoothDateRangePickerFragment ret = new SmoothDateRangePickerFragment();
        ret.initialize(callBack, year, monthOfYear, dayOfMonth, yearEnd, monthofyearend, dayOfMonthEnd);
        return ret;
    }
    ...
    public void initialize(OnDateRangeSetListener callBack, int year, int monthOfYear, int dayOfMonth, int yearend, int monthofyearend, int dayofmonthend) {
        mCallBack = callBack;
